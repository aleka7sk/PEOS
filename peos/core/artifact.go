...
//
// Artifact carries no provenance of its own in this packet: the creation
// and recording of engineering state is a Revision-level concern
// (PEOS-002 requires provenance and origin on every recorded Artifact
// Revision, not separately on the logical Artifact). Artifact also
// carries no external identifiers, title, description, authority,
// status, or Lifecycle state — see artifact.go's package-level rationale
// in the Packet B blueprint: external identifiers are a Product
